	...
	return &FileExclusions{
		...
		ByDatabase: map[Database][]string{
			...
			None: {
				...
				"/internal/initialize/template/base/test/fixtures.go",
				"/internal/initialize/template/base/internal/application/handler/book_handler.go.templ",
				"/internal/initialize/template/base/internal/application/handler/book_handler_test.go.templ",
				"/internal/initialize/template/base/internal/application/handler/auth_handler.go.templ",
				"/internal/initialize/template/base/internal/application/handler/auth_handler_test.go.templ",
				"/internal/initialize/template/base/internal/application/handler/auth_handler_types.go.templ",
				"internal/initialize/template/base/internal/application/service/auth_service.go.templ",
				"internal/initialize/template/base/internal/application/service/auth_service_types.go.templ",
				"internal/initialize/template/base/internal/application/service/book_service.go.templ",
			},
		},
	}
}
